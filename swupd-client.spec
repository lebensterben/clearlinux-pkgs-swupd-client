...
Version  : 3.7.2
Release  : 167
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.7.2/swupd-client-3.7.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.7.2/swupd-client-3.7.2.tar.gz
...
%files autostart
%defattr(-,root,root,-)
/usr/lib/systemd/system/multi-user.target.wants/check-update.timer
