...
Version  : 3.12.7
Release  : 228
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.12.7/swupd-client-3.12.7.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.12.7/swupd-client-3.12.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1509125632
export AR=gcc-ar
