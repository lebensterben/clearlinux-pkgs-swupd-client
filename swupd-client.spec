...
Version  : 3.17.10
Release  : 271
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.17.10/swupd-client-3.17.10.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.17.10/swupd-client-3.17.10.tar.gz
...
%prep
%setup -q -n swupd-client-3.17.10
...
export LANG=C
export SOURCE_DATE_EPOCH=1531947325
export AR=gcc-ar
