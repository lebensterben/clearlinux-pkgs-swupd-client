...
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.17.0/swupd-client-3.17.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1525464110
export AR=gcc-ar
