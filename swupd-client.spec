...
Version  : 3.17.13
Release  : 274
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.17.13/swupd-client-3.17.13.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.17.13/swupd-client-3.17.13.tar.gz
...
%prep
%setup -q -n swupd-client-3.17.13
...
export LANG=C
export SOURCE_DATE_EPOCH=1534960069
export AR=gcc-ar
