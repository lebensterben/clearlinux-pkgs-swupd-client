...
Version  : 3.10.0
Release  : 208
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.10.0/swupd-client-3.10.0.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.10.0/swupd-client-3.10.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1501589427
export AR=gcc-ar
