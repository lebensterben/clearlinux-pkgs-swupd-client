...
Version  : 3.17.12
Release  : 273
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.17.12/swupd-client-3.17.12.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.17.12/swupd-client-3.17.12.tar.gz
...
%prep
%setup -q -n swupd-client-3.17.12
...
export LANG=C
export SOURCE_DATE_EPOCH=1534437352
export AR=gcc-ar
