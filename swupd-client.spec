...
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.8.4/swupd-client-3.8.4.tar.gz
...
%prep
%setup -q -n swupd-client-3.8.4

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490599208
export AR=gcc-ar
