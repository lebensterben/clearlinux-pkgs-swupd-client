...
Version  : 3.14.2
Release  : 238
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.14.2/swupd-client-3.14.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.14.2/swupd-client-3.14.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1513213616
export AR=gcc-ar
