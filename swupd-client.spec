...
Version  : 3.9.2
Release  : 197
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.9.2/swupd-client-3.9.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.9.2/swupd-client-3.9.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495150420
export AR=gcc-ar
