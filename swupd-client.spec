...
Version  : 3.9.1
Release  : 195
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.9.1/swupd-client-3.9.1.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.9.1/swupd-client-3.9.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1494349224
export AR=gcc-ar
