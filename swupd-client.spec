...
Version  : 3.8.2
Release  : 178
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.8.2/swupd-client-3.8.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.8.2/swupd-client-3.8.2.tar.gz
...
%prep
%setup -q -n swupd-client-3.8.2

%build
export LANG=C
export SOURCE_DATE_EPOCH=1488224888
export AR=gcc-ar
...
%files data
%defattr(-,root,root,-)
/usr/share/clear/update-ca/Swupd_Root.pem/157753a5.0
/usr/share/clear/update-ca/Swupd_Root.pem/425b0f6b.0
/usr/share/clear/update-ca/Swupd_Root.pem/425b0f6b.key
/usr/share/clear/update-ca/Swupd_Root.pem/8d28ae65.0
/usr/share/clear/update-ca/Swupd_Root.pem/d6325660.0
/usr/share/clear/update-ca/Swupd_Root.pem/d6325660.1
