...
Version  : 3.8.1
Release  : 177
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.8.1/swupd-client-3.8.1.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.8.1/swupd-client-3.8.1.tar.gz
...
%prep
%setup -q -n swupd-client-3.8.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1486065125
export AR=gcc-ar
