...
Version  : 3.12.2
Release  : 215
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.12.2/swupd-client-3.12.2.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.12.2/swupd-client-3.12.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1505854465
export AR=gcc-ar
