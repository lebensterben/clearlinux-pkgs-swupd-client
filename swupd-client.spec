...
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.9.4/swupd-client-3.9.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1500673319
export AR=gcc-ar
