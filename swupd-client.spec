...
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.17.2/swupd-client-3.17.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526409785
export AR=gcc-ar
