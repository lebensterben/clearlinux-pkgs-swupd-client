...
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.17.5/swupd-client-3.17.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1528836291
export AR=gcc-ar
