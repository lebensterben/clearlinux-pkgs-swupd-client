...
Version  : 3.8.7
Release  : 189
URL      : https://github.com/clearlinux/swupd-client/releases/download/v3.8.7/swupd-client-3.8.7.tar.gz
Source0  : https://github.com/clearlinux/swupd-client/releases/download/v3.8.7/swupd-client-3.8.7.tar.gz
...
%prep
%setup -q -n swupd-client-3.8.7

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492532839
export AR=gcc-ar
